...
```bash
docker buildx build --platform=linux/amd64,linux/arm64,linux/arm/v7 -f Dockerfile -t ghcr.io/rogerwesterbo/nyan-cat:<0.0.11>  --output type=registry,dest=rogerwesterbo/nyan-cat:<0.0.11>,push=true .
```
